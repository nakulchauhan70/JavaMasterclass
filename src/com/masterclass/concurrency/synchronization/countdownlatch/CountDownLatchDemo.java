package com.masterclass.concurrency.synchronization.countdownlatch; /**
...
class Shopper extends Thread {
    ...
    private static CountDownLatch fistBump = new CountDownLatch(5);//greater than 5 will create problem because there are only 5 threads of olivia and counter value will never reach to 0
